...
# --- Inline Pydantic models and utilities have been extracted to ---
# --- src/api/schemas.py and src/server_utils.py                 ---
                    ...
                    try:
                        ...
                        if meta_file.exists():
                            ...
                            indices.append(IndexInfo(
                                ...
                                last_modified=dir_last_modified(root),
                                disk_usage_bytes=dir_disk_usage(root),
                                files_count=dir_file_count(root),
                            ))
                            ...
                            try:
                                ...
                                if meta_file.exists():
                                    ...
                                    indices.append(IndexInfo(
                                        ...
                                        created_at=meta.get("created_at"),
                                        updated_at=meta.get("updated_at"),
                                        last_modified=dir_last_modified(item),
                                        disk_usage_bytes=dir_disk_usage(item),
                                        files_count=dir_file_count(item),
                                    ))
                                    continue
                            except Exception:
                                pass
